...
public class ClashOkno extends Stage {
	...
	private EnergyRitierov energyRitierov;
	...
	public ClashOkno() {
		...
		skrol.setContent(pane);
 		...
 		dalsiStretTlacidlo.setOnAction(e -> {
 			try {
 				vypis.appendText(clash.dalsiStret1na1());
...
*/
 		...
 		spocitajTlacidlo.setOnAction(e -> {
 			switch (typBojovnika.getText()) {
 				case ("r") : vypis.appendText("Rytieri:" + clash.spocitajBojovnikov(Rytier.class) + "\n");
 				break;
 				case ("sr") : vypis.appendText("Statocni rytieri:" + clash.spocitajBojovnikov(StatocnyRytier.class) + "\n");
 				break;
 				case ("o") : vypis.appendText("Obri:" + clash.spocitajBojovnikov(Obor.class) + "\n");
 				break;
 				case ("zo") : vypis.appendText("Zli obri:" + clash.spocitajBojovnikov(AngryObor.class) + "\n");
 				break; 			
 			}
		});

		energyRitierov = new EnergyRitierov(clash);
		clash.pridajObserver(energyRitierov);
		pane.getChildren().add(energyRitierov);
